...
##AutoGeneration
@receiver(post_delete, sender=AutoGeneration)
def AutoGenerationPostDelete(sender=None, instance=None, *args, **kwargs):
    related_edition = instance.generated_version
    if related_edition.existance_type == existanceType.AUTOGENERATED:
        related_edition.existance_type = existanceType.LOCAL
        related_edition.save()
    else:
        raise Exception("AutoGeneration instance deleted, but related edition is not autogenerated")